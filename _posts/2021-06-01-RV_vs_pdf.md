...
If you think I got something wrong or suggest feedback just contact me. Check out the GitHub repo if you want to play around with the code. TODO:link
...
where $$\vert J \vert$$ is the determinant of the Jacobian $$\left\vert \frac{\partial}{\partial y} g^{-1}(Y)$$, i.e.
...
![](/img/RVs_vs_pdfs/Sum_of_Gaussians_Convolution.html)
...
![](/img/RVs_vs_pdfs/Product_of_Gaussians_Mellin_Convolution.html)
