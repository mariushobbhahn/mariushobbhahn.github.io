...
This seems to indicate that China was able to improve the quality of life faster than their population growth since the aggregate is decreasing. Indias population grew as fast as the quality of life per individual improved. 
...
2. We can compare the absolute and relative human suffering to the suffering of other species. I would for example be interested how much suffering is inflicted on animals due to factory farming or wild animal suffering. I will, therefore, extend this question to animals in a future blog post (will be linked when ready).
...
1. DALYs are an accurate measure of human suffering. This is unclear especially because DALYs partly measure years of life lost which, strictly speaking, should not contribute to suffering since the person is dead. However, you could also argue that some of the suffering comes from losses in human capital due to lost workers and family members. Even though it's an imperfect approximation, DALYs are the most accurate measure we currently have data of. But there are good ideas and approaches on better approximations, e.g. <a href='https://www.simonknutsson.com/measuring-happiness-and-suffering/'>this blog post</a> by Simon Knutsson. 
