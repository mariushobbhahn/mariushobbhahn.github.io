...
Broadly speaking there are three kinds of rebuttal. Rebuttal that is mitigatory, rebuttal that refutes an argument and rebuttal that flips an argument. Of course there are additional possibilities to deal with the argument of another team like framing the argument out of the debate or similar stuff. However, these techniques do not deal with the argument directly but rather tell me to care less about the overall clash on which it is based. For example, a team could claim that "even if that argument is well made and people die, this debate is more about a principled question because of XYZ". In this part of the illustration I want to focus on the kind of ways to rebut an argument that directly engage with it instead of framing it out of the debate.
