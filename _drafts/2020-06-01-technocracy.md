...
Just as is already the case in many parts of government, political or industrial organisations people would be selected for their skill and there are some ways to ensure that the selections are reasonable. Two examples where this would have been important: Germanies drug minister and education person. TODO
...
TODO
list of things that turned out different than expected: drugs, criminal punishment and justice & perception of security/crime, housing, police reform (debias training), imigration, healthcare (system underrated), terrorism (overestimated, prevention underrated), war (bodybag -> power vacuums), redistribution, minority rights (trans/gay), economy (game theory), economy (debt level), economy (counterfactuals), minority rights (who does it hurt), nuclear energy, recycling, Anti vax, gmos, effects of meat consumption and factory farming
