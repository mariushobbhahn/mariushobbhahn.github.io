...
Before we can answer important moral questions such as "which cause is most cost-efficient w.r.t. the reduction of suffering?" we first have to have an approximate view of the status quo. While there are lots of reports of the horrendous conditions that animals face in factory farming (see TODO), I want to attempt to give a quantitative estimate of how much suffering animals face in factory farms and 
fishfarms. This post is the second in a series on approximating the amount of suffering in the world. I would recommend to check out the first post TODO:link to get a better understanding of the ideas but especially recommend it if you are unfamiliar with the concepts of disease burden and disability-adjusted life years TODO:links. I also want to emphasize that this post does not include estimates for wild animal suffering but is restricted to animals held and killed for human consumption but I will try to make a similar estimate for wild animals in a future post. 
...
Similar to last article I am just an interested stat nerd that crunched some numbers and made some plots. The hard work of collecting the data and cleaning them has been mostly done by others such as ourworldindata.org or the WHO. 

## Why should animal suffering have moral weight?

Before we actually start comparing I think it is important to revisit the reasons why we should give animal suffering some moral weight. This is both for people who are rather new to these ideas but also for those who currently do not believe in them. If you have any objections regarding the following arguments please let me know. They are a summary of the absolutely excellent openphil article TODO:link on consciousness and moral patienthood (Check the article for more elaborate explanations).

TODO: list the important reasons
...
There are many quualitative reports (TODO:list) on the bad conditions in factory farms. TODO: make a long list to get the vibe across. 
